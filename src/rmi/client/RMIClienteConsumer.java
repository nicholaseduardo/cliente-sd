 ...
 * @author nicho
 */
public class RMIClienteConsumer {

    private Scanner s;
    private IRemoteController stub;

    public RMIClienteConsumer(String hostname) throws RemoteException, NotBoundException {
        s = new Scanner(System.in);
        Registry registro = LocateRegistry.getRegistry(hostname);
        stub = (IRemoteController) registro.lookup("RMIServer");
    }
    ...
    public void cadastrar(Integer id) throws RemoteException {
        ...
        Cliente c = ClienteFactory.getInstance().getPessoa(id, nome, email, celular);
        c.setCpf(cpf);
        stub.salvar(c);
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            RMIClienteConsumer rmiClient = new RMIClienteConsumer(s.nextLine());
            rmiClient.iniciar();
        } catch (RemoteException ex) {
            Logger.getLogger(RMIClienteConsumer.class.getName()).log(Level.SEVERE, null, ex);
